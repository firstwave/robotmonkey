...
public class SeeMonkeyDevice extends Region implements IScreen {
	public static final String TAG = "SeeMonkeyDevice:";
	...
	public SeeMonkeyDevice(IChimpDevice device) {
		_device = device;
		_robot = new SeeMonkeyRobot(_device);
		
		Rectangle b = getBounds();
		init(b.x, b.y, b.width, b.height, this);
	
		//_viewManager = new ViewManager(_device);
	}
...
//    }
//    
//    public Finder finder(String resource) {
//    	try {
...
//    }
    ...
    /**
     * 
     * @return device's ViewManager instance
     */
    public ViewManager getViewManager() {
    	return _viewManager;
    }

    public MonkeyDevice getMonkeyDevice() {
